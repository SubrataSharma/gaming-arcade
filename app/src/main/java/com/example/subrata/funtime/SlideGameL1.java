...
public class SlideGameL1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1 = (Button)findViewById(R.id.sgl1b1);
        b2 = (Button)findViewById(R.id.sgl1b2);
        b3 = (Button)findViewById(R.id.sgl1b3);
        b4 = (Button)findViewById(R.id.sgl1b4);
        b5 = (Button)findViewById(R.id.sgl1b5);
        b6 = (Button)findViewById(R.id.sgl1b6);
        b7 = (Button)findViewById(R.id.sgl1b7);
        b8 = (Button)findViewById(R.id.sgl1b8);
        b9 = (Button)findViewById(R.id.sgl1b9);
